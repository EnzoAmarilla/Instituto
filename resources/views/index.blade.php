					...
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-9 col-md-12">
							<h1 class="text-uppercase">
								ASEGURAMOS UNA MEJOR EDUCACIÓN PARA UN MUNDO MEJOR			
							</h1>
							<p class="pt-10 pb-10">
								En la historia de la astronomía moderna, probablemente no haya un gran salto adelante que la construcción y el lanzamiento del telescopio espacial conocido como Hubble.
							</p>
							<a href="#" class="primary-btn text-uppercase">Empezar</a>
						</div>										
					</div>
				</div>					
			</section>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
									<h4>Aprender cursos en línea</h4>
								</div>
								<div class="desc-wrap">
									<p>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								...
								<p>Compartimos todos los momentos vividos con nuestros alumnos.</p>
							</div>
						</div>
					</div>						
					<div class="row">
							...
							<div class="single-popular-carusel">
								<div class="thumb-wrap relative">
									...
									<div class="meta d-flex justify-content-between">
										<p><span class="lnr lnr-users"></span> 2020-09-07 </p>
										<h4>Alumnos</h4>
									</div>									
								</div>
								<div class="details">
									...
									<p>
										Reserva tu turno online para una entrevista de Admision.										
									</p>
								</div>
							</div>	
							<div class="single-popular-carusel">
								...
								<div class="details">
									...
									<p>
										A partir de septiembre la administración del colegio estará abierta los días martes, miércoles y jueves de 9 a 13 hs.										
									</p>
								</div>
							</div>	
							<div class="single-popular-carusel">
			...
			<section class="upcoming-event-area section-gap">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Próximos eventos de nuestro Instituto</h1>
								<p>Proximas fechas y realización de evento</p>
							</div>
						</div>
					</div>								
					<div class="row">
			...
			<section class="cta-one-area relative section-gap">
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="wrap">
							<h1 class="text-white">Trabajá con nosotros</h1>
							<p>
			...
			<section class="blog-area section-gap" id="blog">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Últimas publicaciones de nuestro Blog</h1>
